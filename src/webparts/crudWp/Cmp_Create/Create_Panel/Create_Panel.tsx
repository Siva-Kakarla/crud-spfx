...
//   }
  ...
  function Welcome(props) {
    return <h1>Hello, {props.name + props.siva}</h1>;
  }
  
  export class PanelScrollExample extends React.Component<IPanelScrollExamplePropes, {}> {
    public render() 
    {
      return (
        <div>
          ...
          <Panel
            isOpen={this.props.iSshowPanel}
            type={PanelType.smallFixedFar}
            onDismiss={this.props.Cancel_Panel}

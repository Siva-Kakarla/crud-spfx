...
export interface IPanelScrollExamplePropes
{
  Save_Panel_Data: () => void;
}

export class PanelScrollExample extends React.Component<IPanelScrollExamplePropes, IPanelScrollExampleState>
{
  constructor(props: IPanelScrollExamplePropes, state: IPanelScrollExampleState) {
    super(props);
    this.state = {
        showPanel:true
    };
    ...
    return (
      <div>
        ...
        <Panel
          ...
          // onDismiss={this.ChangeState_OfPanel.bind(this)}
  ...
  private _onRenderFooterContent = (): JSX.Element => {
    return (
      <div>
        <PrimaryButton onClick={this.props.Save_Panel_Data} style={{ marginRight: '8px' }}>
          Save
        </PrimaryButton>
